...
export function StatCard({
  ...
  accent: "emerald" | "rose" | "sky" | "slate" | "amber";
}) {
  const topAccent = {
  ...
  const wash = {
    ...
    amber: "from-amber-600/[0.025] to-transparent",
  };
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        />
        {hint ? (
          <div className="mt-2 text-[11px] leading-snug text-[#94A3B8]">{hint}</div>
        ) : null}
      </div>
    </div>
  );
